...
<Steps>
  ...
  <Step title="Click Upgrade">
    Click the **Upgrade** button. Argus redirects you to a secure checkout session with our payment provider.
  </Step>
  <Step title="Complete checkout">
    Enter your payment details in the checkout flow. Your plan upgrades immediately upon successful payment — no restart required.
  </Step>
