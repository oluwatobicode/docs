...
description: "Install @argus/sdk-node to capture uncaughtException and unhandledRejection events in Node.js apps, with optional Express middleware."
---
...
```typescript
import { captureException } from '@argus/sdk-node';
...
import type { InitOptions } from '@argus/sdk-node';
```
