---
title: "Your Argus DSN: Project Connection String"
sidebarTitle: "DSN"
description: "A DSN (Data Source Name) connects your SDK to a specific Argus project. Learn the format, where to find it, and how to use it."
---
...
|---|---|
| `PUBLIC_KEY` | Authenticates your SDK with the ingest endpoint. Argus uses this as the `X-Argus-Key` header on every envelope it sends. It is **not** a secret — it's safe to include in frontend code. |
